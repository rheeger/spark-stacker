...
class BaseConnector(abc.ABC):
    ...
    def __init__(
        self, name: str, exchange_type: str, market_types: List[MarketType] = None
    ):
        """
    ...
    def supports_derivatives(self) -> bool:
        ...
        """
        return (
            MarketType.PERPETUAL in self.market_types
            or MarketType.FUTURES in self.market_types
        )
    ...
    def get_funding_rate(self, symbol: str) -> Dict[str, Any]:
        ...
        if not self.supports_derivatives:
            ...
            raise NotImplementedError(
                "This method must be implemented by derivatives connector"
            )
    ...
    def calculate_margin_requirement(
        self, symbol: str, size: float, leverage: float = 1.0
    ) -> Tuple[float, float]:
        """
