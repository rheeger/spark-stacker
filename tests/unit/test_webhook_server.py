...
def test_process_webhook_valid_json(mock_parse_signal, webhook_server, mock_signal_handler):
...
@patch.object(WebhookServer, 'parse_signal')
def test_process_webhook_invalid_auth(mock_parse_signal, webhook_server, mock_signal_handler):
...
@patch.object(WebhookServer, 'parse_signal')
def test_process_webhook_invalid_json(mock_parse_signal, webhook_server, mock_signal_handler):
...
def test_process_tradingview_alert(mock_parse_tradingview, webhook_server, mock_signal_handler):
